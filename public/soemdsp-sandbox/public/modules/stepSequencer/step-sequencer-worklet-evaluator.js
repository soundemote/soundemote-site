...
NodeLiveAudioProcessor.prototype.stepSequencerSampleJs = function stepSequencerSampleJs(state, trigger, reset, params) {
...
NodeLiveAudioProcessor.prototype.stepSequencerSample = function stepSequencerSample(state, trigger, reset, params) {
    ...
    return this.stepSequencerSampleJs(state, trigger, reset, params);
  };
