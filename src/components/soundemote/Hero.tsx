...
export const Hero = () => {
  ...
  const previewFrameClass = sandboxLoaded
    ? "soundemote-sandbox-preview-frame relative flex w-full max-w-[900px] mx-auto justify-center overflow-hidden rounded-[20px] border border-white/[0.07] bg-transparent"
