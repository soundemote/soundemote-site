...
export function mountGradientCurveWidget(host, options = {}) {
  ...
  const state = {
    ...
    archFps: Number.isFinite(Number(options.archFps)) ? clamp(Math.round(Number(options.archFps)), 0, 60) : 0,
  ...
  const GRADIENT_PRESETS = [
    { label: "Ember", colors: ["#000000", "#7A1500", "#FF6B1A", "#FFE08A", "#FFFFFF"] },
    { label: "Ocean", colors: ["#000000", "#001B2E", "#0F5E7A", "#2EC4B6", "#CFF9F3"] },
    { label: "Neon", colors: ["#000000", "#12002E", "#7A00FF", "#FF00A8", "#00E5FF", "#FFFFFF"] },
    { label: "Sunset", colors: ["#000000", "#2B0A3D", "#B5179E", "#F72585", "#FFB703"] },
    { label: "Forest", colors: ["#000000", "#04130B", "#1B5E20", "#66BB6A", "#E8F5E9"] },
    { label: "Mono", colors: ["#000000", "#555555", "#AAAAAA", "#FFFFFF"] },
    { label: "Plasma", colors: ["#000000", "#0D0887", "#7E03A8", "#CC4778", "#F89540", "#F0F921"] },
    { label: "Viridis", colors: ["#000000", "#440154", "#3B528B", "#21918C", "#5EC962", "#FDE725"] },
    { label: "Magma", colors: ["#000000", "#3B0F70", "#8C2981", "#DE4968", "#FEC287"] },
    { label: "Inferno", colors: ["#000000", "#57106E", "#BC3754", "#F98C0A", "#FCFFA4"] },
    { label: "Aurora", colors: ["#000000", "#011627", "#00B4A6", "#41EAD4", "#B2F7EF", "#FFFFFF"] },
    { label: "Ultraviolet", colors: ["#000000", "#03001C", "#301E67", "#5B8FB9", "#B6EADA", "#FFFFFF"] },
    { label: "Lava", colors: ["#000000", "#6A040F", "#DC2F02", "#F48C06", "#FFBA08", "#FFFFFF"] },
    { label: "Ice", colors: ["#000000", "#03045E", "#0077B6", "#00B4D8", "#90E0EF", "#CAF0F8"] },
    { label: "Candy", colors: ["#000000", "#1A0B2E", "#7B2CBF", "#E0AAFF", "#FF99C8", "#FFF1E6"] },
    { label: "Spectrum", colors: ["#000000", "#FF0000", "#FFAA00", "#AAFF00", "#00FFAA", "#00AAFF", "#AA00FF", "#FFFFFF"] },
    { label: "Copper", colors: ["#000000", "#5C2E00", "#B87333", "#E6A857", "#FFE9C7"] },
    { label: "Vaporwave", colors: ["#000000", "#0F0326", "#7303C0", "#EC38BC", "#FDEFF9", "#03A9F4", "#FFFFFF"] },
  ];
