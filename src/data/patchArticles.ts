...
export const PATCH_ARTICLES: PatchArticle[] = [
  {
    ...
    status: "live",
    patchUrl: "/soemdsp-sandbox/patches/sandbox.json",
    category: "Manifesto",
    badges: [
...
outward from there.`,
  },
  {
    ...
    status: "live",
    patchUrl: "/soemdsp-sandbox/patches/surgeoscillator.json",
...
better-armed.`,
  },
  {
    ...
    status: "live",
    patchUrl: "/soemdsp-sandbox/patches/shootingstar.json",
...
between a droning hum and an unstable shriek. That's chaos theory, not a bug.`,
  },
  {
    ...
    status: "live",
    patchUrl: "/soemdsp-sandbox/patches/sinewave.json",
    category: "Oscillator",
    badges: [
      { label: "status", value: "live", tone: "scope" },
...
harder problem than it looks.`,
  },
  {
    ...
    status: "live",
    patchUrl: "/soemdsp-sandbox/patches/polyblep.json",
    category: "Oscillator",
    badges: [
      { label: "status", value: "live", tone: "scope" },
      { label: "modules", value: "1", tone: "muted" },
