export const ARCHIMEDES_ARTICLE_SOURCE_URL =
  "https://github.com/soundemote/soemdsp-sandbox/blob/master/native_modules/archimedes/archimedes.cpp";

export const ARCHIMEDES_ARTICLE_MARKDOWN = `# 🥧 Computing π for Free — the Archimedes Oscillator ⚙️
